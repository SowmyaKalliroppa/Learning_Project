...
public class SearchLead_AnnualRevenue {
	/**
	 * Method to search lead by clicking on annual revenue
	 * @throws Throwable
	 */
	@Test
	public void  TC051_searchLead_Revenue() throws Throwable {
	  ...
	  WebElement ele = driver.findElement(By.className("detailedViewTextBox"));
	    //  driver.findElement(By.className("detailedViewTextBox")).click();
	     ...
	     s.selectByValue("vtiger_leaddetails:annualrevenue:annualrevenue:Leads_Annual_Revenue:I");
